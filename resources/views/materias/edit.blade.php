...
<div class="py-3">
    ...
    <h5 class="fw-bold mt-1">Editar Materia: {{ $materia->nombre }}</h5>
</div>
        ...
        <form method="POST" action="{{ route('materias.update', $materia) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="clave_materia" name="clave_materia"
                       ...
                       value="{{ old('clave_materia', $materia->clave_materia) }}" maxlength="50" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="nombre" name="nombre"
                       ...
                       value="{{ old('nombre', $materia->nombre) }}" maxlength="150" required>
            ...
            <div class="row">
                <div class="col-6 mb-4">
                    ...
                    <input type="number" id="creditos" name="creditos"
                           ...
                           value="{{ old('creditos', $materia->creditos) }}" min="1" required>
                ...
                <div class="col-6 mb-4">
                    ...
                    <input type="number" id="semestre_sugerido" name="semestre_sugerido"
                           class="form-control"
                           value="{{ old('semestre_sugerido', $materia->semestre_sugerido) }}" min="1">
                </div>
            </div>
