...
<div class="py-3">
    ...
    <h5 class="fw-bold mt-1">Editar Carrera: {{ $carrera->nombre }}</h5>
</div>
        ...
        <form method="POST" action="{{ route('carreras.update', $carrera) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="clave_oficial" name="clave_oficial"
                       ...
                       value="{{ old('clave_oficial', $carrera->clave_oficial) }}" maxlength="50" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="nombre" name="nombre"
                       ...
                       value="{{ old('nombre', $carrera->nombre) }}" maxlength="150" required>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="total_creditos" name="total_creditos"
                       ...
                       value="{{ old('total_creditos', $carrera->total_creditos) }}" min="1" required>
