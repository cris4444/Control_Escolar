...
<div class="py-3">
    ...
    <h5 class="fw-bold mt-1">Editar Periodo: {{ $periodo->codigo }}</h5>
</div>
        ...
        <form method="POST" action="{{ route('periodos.update', $periodo) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="codigo" name="codigo"
                       ...
                       value="{{ old('codigo', $periodo->codigo) }}" maxlength="20" required>
            ...
            <div class="mb-3">
                ...
                <input type="date" id="fecha_inicio" name="fecha_inicio"
                       ...
                       value="{{ old('fecha_inicio', $periodo->fecha_inicio) }}" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="fecha_fin" name="fecha_fin"
                       ...
                       value="{{ old('fecha_fin', $periodo->fecha_fin) }}" required>
